...
function _themename_post_metabox_html($post) {
    ...
    echo '<p><label for="_themename_post_subtitle_field">'.esc_html__( 'Subtitle: ', '_themename' ).'</label>'.
    ...
    echo '<p><label for="_themename_post_layout_field">'.esc_html__( 'Layout: ', '_themename' ).'</label>'; ?>
    <select name="_themename_post_layout_field" id="_themename_post_layout_field" class="widefat">
        ...
        <option <?php selected( $layout, 'sidebar' ); ?> value="sidebar"><?php esc_html_e( 'With sidebar', '_themename' ); ?></option>
    </select>
    <?php
}
