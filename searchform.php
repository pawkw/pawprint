		...
		<div class="col-lg-12">
			<div class="input-group">
				...
				<span class="input-group-btn">
                    <button class="btn pawprint-search-button" type="submit"><span class="sr-only sr-only-focusable"><?php echo esc_html_x( 'Submit', 'submit button', '_themename' ); ?></span><i class="fas fa-search" aria-hidden="true"></i></button>
				</span>
			</div>
		</div>
	</div>
